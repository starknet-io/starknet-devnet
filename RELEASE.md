...
3. Create a PR styled after [this one](https://github.com/starknet-io/starknet-devnet-rs/pull/473).

4. Adapt [starknet-devnet-js](https://github.com/starknet-io/starknet-devnet-js) to the newly released Devnet. Check out one of the [old adaptation PRs](https://github.com/starknet-io/starknet-devnet-js/pulls?q=is%3Apr+is%3Aclosed) for reference.
